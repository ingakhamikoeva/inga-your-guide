...
const medalCopy: Record<MedalType, { titles: string[]; descriptions: string[] }> = {
  ...
  strong: {
    ...
    descriptions: [
      ...
      'За неделю получилось заметное движение — продолжайте без давления',
  ...
  consistency: {
    ...
    descriptions: [
      ...
      'Вы были в процессе — и это важнее идеального дня',
      'Регулярность уже работает как фундамент для изменений',
      'Вы возвращались к дневнику, а значит сохраняли курс',
    ],
  },
};
