...
export interface LightRecipeEntry {
  ...
  portionGrams: number;             // типичная порция по методу, г/мл (утверждено Ингой, июль 2026)
...
export const LIGHT_RECIPES: LightRecipeEntry[] = [
  ...
  { recipeId: 'zucchini', portionGrams: 100, recipeSection: 'breakfasts', name: 'Оладьи из кабачков', lightKcal: 83.2, hasVideo: true,
  ...
  { recipeId: 'bliny', portionGrams: 100, recipeSection: 'breakfasts', name: 'Блины', lightKcal: 99, hasVideo: true,
  ...
  { recipeId: 'varenie', portionGrams: 100, recipeSection: 'breakfasts', name: 'Пектиновое варенье', lightKcal: 40, hasVideo: true,
    aliases: ['варенье', 'джем', 'повидло', 'конфитюр'],
    classicLabel: 'варенье с сахаром', classicKcal: 250, tagline: 'тот же ягодный вкус' },
  { recipeId: 'shaurma', portionGrams: 250, recipeSection: 'breakfasts', name: 'Шаурма', lightKcal: 104.2, hasVideo: true,
    aliases: ['шаурма', 'шаверма', 'ролл', 'лаваш', 'заверните две'],
    classicLabel: 'уличная шаурма', classicKcal: 250, tagline: 'тот же сочный вкус' },
  { recipeId: 'taco', portionGrams: 200, recipeSection: 'breakfasts', name: 'Тако', lightKcal: 80, hasVideo: true,
    aliases: ['тако', 'такос', 'мексиканское'],
    classicLabel: 'классическое тако', classicKcal: 220, tagline: 'тот же яркий вкус' },
  { recipeId: 'pirozhki', portionGrams: 150, recipeSection: 'breakfasts', name: 'Пирожки', lightKcal: 113.2, hasVideo: true,
    aliases: ['пирожки', 'пирожок', 'как настоящие'],
    classicLabel: 'жареные пирожки', classicKcal: 290, tagline: 'тот же вкус из детства' },
  { recipeId: 'nezhnost', portionGrams: 100, recipeSection: 'sweet', name: 'Шоколадный пирог', lightKcal: 95, hasVideo: true,
  ...
  { recipeId: 'nevesimost', portionGrams: 100, recipeSection: 'sweet', name: 'Меренговый рулет', lightKcal: 56, hasVideo: true,
    aliases: ['безе', 'меренга', 'меренговый рулет', 'невесомость'],
    classicLabel: 'меренговый рулет', classicKcal: 300, tagline: 'та же воздушность' },
  { recipeId: 'oblaka', portionGrams: 100, recipeSection: 'sweet', name: 'Яблочное суфле', lightKcal: 40.2, hasVideo: true,
  ...
  { recipeId: 'slivovoe', portionGrams: 100, recipeSection: 'sweet', name: 'Сливовое варенье', lightKcal: 40, hasVideo: true,
    aliases: ['сливовое варенье', 'сливы', 'варенье'],
    classicLabel: 'варенье с сахаром', classicKcal: 250, tagline: 'тот же сливовый вкус' },
  { recipeId: 'grusha', portionGrams: 100, recipeSection: 'sweet', name: 'Грушевый пирог', lightKcal: 117, hasVideo: true,
  ...
  { recipeId: 'milfey', portionGrams: 100, recipeSection: 'sweet', name: 'Яблочный мильфей', lightKcal: 68, hasVideo: true,
  ...
  { recipeId: 'morozhenoe', portionGrams: 100, recipeSection: 'sweet', name: 'Ягодное мороженое', lightKcal: 60, hasVideo: true,
  ...
  { recipeId: 'maffiny', portionGrams: 100, recipeSection: 'sweet', name: 'Маффины', lightKcal: 124.6, hasVideo: false,
  ...
  { recipeId: 'sharlotka', portionGrams: 100, recipeSection: 'sweet', name: 'Шарлотка', lightKcal: 122, hasVideo: false,
  ...
  { recipeId: 'okroshka', portionGrams: 300, recipeSection: 'soups', name: 'Окрошка', lightKcal: 42, hasVideo: false,
    aliases: ['окрошка'],
    classicLabel: 'окрошка с колбасой и сметаной', classicKcal: 100, tagline: 'тот же летний вкус' },
  { recipeId: 'turkey-cutlets', portionGrams: 100, recipeSection: 'lunches', name: 'Котлеты из индейки', lightKcal: 136, hasVideo: false,
    aliases: ['котлеты', 'котлета', 'биточки'],
    classicLabel: 'жареные котлеты', classicKcal: 250, tagline: 'тот же сочный вкус' },
  { recipeId: 'fried-potatoes-mushrooms', portionGrams: 200, recipeSection: 'lunches', name: 'Жареная картошка с грибами', lightKcal: 60, hasVideo: false,
  ...
  { recipeId: 'pizza', portionGrams: 200, recipeSection: 'baking', name: 'Пицца «Я худею»', lightKcal: 118.3, hasVideo: true,
    aliases: ['пицца'],
    classicLabel: 'магазинная пицца', classicKcal: 265, tagline: '' },
  { recipeId: 'cappuccino', portionGrams: 200, recipeSection: 'drinks', name: 'Протеиновый капучино', lightKcal: 54, hasVideo: true,
