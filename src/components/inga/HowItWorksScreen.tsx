...
const ROUTINES: RoutineBlock[] = [
  {
    ...
    border: '#FAC775',
    items: [
      { emoji: '⚖️', title: 'Записывайте вес', hint: 'Натощак, после туалета — самый точный момент' },
      { emoji: '💤', title: 'Сон — сколько часов', hint: 'Сон влияет на вес сильнее, чем кажется' },
      { emoji: '👟', title: 'Шаги за вчера', hint: 'Смотрите в телефоне или на фитнес-браслете' },
    ],
  },
  {
    title: 'В ТЕЧЕНИЕ ДНЯ',
    ...
    border: '#9FE1CB',
    items: [
      { emoji: '📝', title: 'Записывайте приёмы пищи', hint: 'Я проанализирую и предложу лёгкие замены' },
      { emoji: '🥛', title: 'Следите за водой — 6 стаканов', hint: 'Выпили стакан — нажмите иконку вверху экрана' },
    ],
  },
  {
    ...
    border: '#C9B8E8',
    items: [
      { emoji: '💬', title: 'Расскажите, как прошёл день', hint: 'Как себя чувствовали — я рядом' },
    ],
  },
];
