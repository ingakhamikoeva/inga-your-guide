...
const getSosOptions = (sex: UserSex) => [
  ...
  { id: 'stress', label: '😰 Стресс / тревога', response: { support: getText('Ты не должна быть сильной 24/7. Иногда нужно просто остановиться.', 'Ты не должен быть сильным 24/7. Иногда нужно просто остановиться.', sex), explain: 'Стресс повышает кортизол, который усиливает тягу к быстрым углеводам.', action: 'Сделай 5 глубоких вдохов. Налей тёплый чай. Дай себе 10 минут тишины.', food: '' } },
  { id: 'tired', label: getText('😴 Устала, нет сил', '😴 Устал, нет сил', sex), response: { support: 'Усталость — это не лень. Это сигнал, что ресурс на нуле.', explain: 'Когда тело устало, мозг ищет быстрый источник энергии — еду.', action: 'Если есть возможность — отдохни 15 минут. Если нет — простой перекус без готовки.', food: 'Кефир 1%, йогурт без сахара низкой жирности, творог 0% с ягодами или нарезанные овощи.' } },
];
