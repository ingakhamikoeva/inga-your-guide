...
const getSosOptions = (sex: UserSex) => [
  ...
  { id: 'tired', label: getText('😴 Устала, нет сил', '😴 Устал, нет сил', sex), response: { support: 'Усталость — это не лень. Это сигнал, что ресурс на нуле.', explain: 'Когда тело устало, мозг ищет быстрый источник энергии — еду.', action: 'Если есть возможность — отдохни 15 минут. Если нет — простой перекус без готовки.', food: 'Хлебец с авокадо, банан, горсть орехов.' } },
];
