      ...
      {hasProgress ? (
        <>
          <div className="inga-bubble text-center max-w-sm mb-8">
            ...
            <p className="text-muted-foreground">Я сохранила ваши ответы. Продолжим с того места, где остановились?</p>
          </div>
        ...
        <>
          <div className="inga-bubble text-center max-w-sm mb-8">
            ...
            <p className="text-muted-foreground">Вас ждут вкусная еда, понятная система и поддержка на каждом этапе.</p>
          </div>
